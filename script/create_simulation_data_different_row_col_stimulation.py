...
def save_evolution(input_signal, rows, cols, dictionary, save_fold):
    ...
    # visualize.plot_network(G=net.G, numeric_label=False, labels=labels, figsize=(14, 14))
    # plt.savefig('/Users/dav/PycharmProjects/Percolation-and-Conduction-in-MemNet/net_stimul_different_row_col.svg')
    # plt.close()
...
if __name__ == "__main__":
    ...
    parser.add_argument('-svp', '--save_path', default='OutputGridAdiabatic_diff_RowCol', type=str)
