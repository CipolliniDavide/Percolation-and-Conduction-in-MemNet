'''
Source:
https://github.com/MilanoGianluca/Grid-Graph_Modeling_Memristive_Nanonetworks
'''


#%% IMPORT FUNCTIONS
def Milano_implementation(src, gnd, V_list, t_list, lin_size=21):
    import sys
    import numpy as np
    ...
    from .functions import define_grid_graph,define_grid_graph_2,initialize_graph_attributes, mod_voltage_node_analysis, \
        calculate_network_resistance, update_edge_weigths, node_map
    ...
    rows = lin_size #21 # number of nodes' rows of the graph
    cols = lin_size #21 # number of nodes' columns of the graph
    random_diag = 0 # 1 = with random diagonals, 0 = without random diagonals
